...
export default function Marketing({section_ref, whatsappMessage}) {
  return (
    <div className='flex flex-col w-full items-center justify-center gap-[64px]'>
      <div className='flex flex-col items-center justify-center gap-[25px]'>
        <div className='md:text-[60px] sm:text-[40px] text-center font-bold w-[80%] gap-2 leading-[50px]'>
          Pra quem <span className='text-secondary animate-shine'>só acredita vendo </span>
        </div>
        <Carousel />
      </div>
      <div ref={section_ref} className='md:p-0 sm:px-2 flex flex-col items-center justify-center gap-6 '>
