...
export default function Modal({ children, show = false, close = () => { }, className }) {
  return (show ?
    <div className='fixed flex items-center justify-center z-[2000] w-full h-full '>
      ...
      <div className={`bg-[#202020] items-center justify-center max-w-[600px] max-h-[600px] ${className || "w-fit h-fit"} rounded-2xl animate-slide_from_bottom_sm shadow-lg relative`}>
